...
init offset = -1
default say_style = "Interrogation" #Interrogation vs Cutscene
    ...
    window:
        ...
        if who is not None:
            ...
            window:
                id "namebox"
                style "namebox"
                text who id "who" xpos (15 if say_style == "Interrogation" else 40) ypos (20 if say_style == "Interrogation" else 25)
                at transform:
                    alpha 1.0
